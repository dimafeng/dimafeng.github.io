...
For last year, I've been dealing with multiple distributed systems and suffer from lack of structured understanding of how it all work under the hood. This post aims to break the subject down into small parts and
